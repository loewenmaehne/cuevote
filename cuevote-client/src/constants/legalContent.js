			...
			sections: [
				...
				},
				{
					...
					list: [
						...
						{ title: "Server Logs & Security", text: "To ensure the stability and security of our service (e.g., defense against DDoS attacks), we process technical connection data (IP address and timestamp). This connection data is initially processed by our CDN provider (Cloudflare) at the network edge for security and routing purposes before reaching our servers. Additionally, IPs may be held briefly in application memory (up to 1 minute) for connection-level abuse protection. Retention: server access logs (nginx) are rotated daily by standard Debian logrotate and retained for approximately 14 days; in-memory rate-limit data is purged automatically after 1 minute. Legal basis: Legitimate Interest (Art. 6.1.f GDPR)." },
			...
			sections: [
				...
				},
				{
					...
					list: [
						...
						{ title: "Serverlogs & Beveiliging", text: "Om de stabiliteit en veiligheid van onze dienst te garanderen (bijv. verdediging tegen DDoS-aanvallen), verwerken wij technische verbindingsgegevens (IP-adres en tijdstempel). Deze verbindingsgegevens worden eerst door onze CDN-provider (Cloudflare) verwerkt aan de rand van het netwerk voor beveiligings- en routeringsdoeleinden voordat ze onze servers bereiken. Daarnaast kunnen IP-adressen kortstondig in het applicatiegeheugen worden bewaard (maximaal 1 minuut) ter bescherming tegen misbruik op verbindingsniveau. Bewaartermijn: server-toegangslogs (nginx) worden dagelijks geroteerd via standaard Debian logrotate en ongeveer 14 dagen bewaard; in-memory rate-limit-gegevens worden automatisch na 1 minuut gewist. Rechtsgrond: Gerechtvaardigd Belang (Art. 6.1.f AVG)." },
