export const translations = {
	...
	"ro": {
		...
		header: {
			...
			autoRefill: "Auto-DJ",
			autoRefillTooltip: "Adaugă automat din istoric când e gol. Începe de la 5 videoclipuri.",
	...
	"bg": {
		...
		header: {
			...
			autoRefillTooltip: "Автоматично добавяне от историята, когато е празно. Започва от 5 видео.",
	...
	"ar": {
		...
		header: {
			...
			autoRefillTooltip: "إضافة تلقائية من السجل عند الفراغ. يبدأ عند 5 مقاطع فيديو.",
	...
	"he": {
		...
		header: {
			...
			autoRefillTooltip: "הוסף אוטומטית מההיסטוריה כשהתור ריק. מתחיל ב-5 סרטונים.",
			venueMode: "מצב מסיבה",
