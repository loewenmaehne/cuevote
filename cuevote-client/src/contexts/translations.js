export const translations = {
	en: {
		...
		header: {
			...
			autoRefillTooltip: "Automatically add videos from history when queue is empty. Starts at 5 videos.",
	...
	pt: {
		...
		header: {
			...
			autoRefillTooltip: "Adicionar auto do histórico se vazia. Inicia com 5 vídeos.",
	...
	ja: {
		...
		header: {
			...
			autoRefill: "自動補充",
			autoRefillTooltip: "空の時に履歴から自動追加。5動画から開始。",
			venueMode: "パーティーモード",
	...
	ko: {
		...
		header: {
			...
			autoRefill: "자동 리필",
			autoRefillTooltip: "비었을 때 기록에서 자동 추가. 5동영상부터 시작.",
			venueMode: "파티 모드",
