...
// layout — never a floating overlay. This keeps it out of the way of every
// header button, footer control, and floating action button in the app.
// Cinema Mode auto-handles itself: the header that hosts this subtitle is
// already hidden during fullscreen playback, and the IFrame player surfaces
// its own YouTube logo bottom-right.
