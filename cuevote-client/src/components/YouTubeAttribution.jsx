...
export function YouTubeAttribution() {
	...
	return (
		<div
			className="fixed bottom-2 left-2 z-[200] flex items-center gap-1.5 text-[10px] text-neutral-400 select-none pointer-events-none bg-black/50 backdrop-blur-sm rounded-md px-2 py-1 border border-white/5"
