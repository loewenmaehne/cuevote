...
// Anchored regex so we don't accept "PT1H...garbage" or "garbagePT1H";
// non-capturing groups + an explicit '0' default replace the
// parseInt("1H") trick (which used to work, just confusingly).
